...
export const ChatFooter = () => {
    return <div className="chat-footer">
        <div className="chat-footer--inner">
            <div className="chat-footer--emoji-outer">
                <div className="chat-footer--emoji">
            ...
            <div className="chat-footer--attach-outer">
                <div className="chat-footer--attach">
            ...
            <div className="chat-footer--message-outer">
                <input className="chat-footer--message" placeholder="Type something"/>
            </div>
            <div className="chat-footer--micro-outer">
                <div className="chat-footer--micro">
                    <svg viewBox="0 0 24 24" width="24" height="24" className="">
                        <path fill="currentColor"
