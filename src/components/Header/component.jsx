...
export const Header = () => {
    return <div className='header'>
        <div className='header-inside'>
            <div className='logo'>
                <Icon src={logo} alt={'logo'} width={'40px'} height={'40px'}/>
            </div>
            <div className='header-options'>
                <div className='header-options__elem'>
                    <div className='header-options__elem-container'>
                        <svg version="1.1"  x="0" y="0" viewBox="0 0 24 24" width="24"
                             height="24">
